...
import '../delivered_to/delivered_viewed_screen.dart';
                        ...
                        child: StreamProvider<ChatScreenStates>(
                          ...
                          child: Selector<ChatScreenStates, ChatScreenStates>(
                              ...
                              builder: (_, state, __) {
                                ...
                                return GroupedListView<QBMessageWrapper,
                                    DateTime>(
                                  elements: (state as LoadMessagesSuccessState)
                                      .messages,
                                  ...
                                  groupBy: (QBMessageWrapper message) =>
                                      DateTime(message.date.year,
                                          message.date.month, message.date.day),
                                  groupHeaderBuilder:
                                      (QBMessageWrapper message) => Row(
                                          mainAxisAlignment:
                                  ...
                                  itemBuilder: (context,
                                      ...
                                      GestureDetector(
                                          child: ChatListItem(
                                              Key(RandomUtil.getRandomString(
                                                  10)),
                                              message,
                                              _dialogType),
                                          onTapDown: (details) {
