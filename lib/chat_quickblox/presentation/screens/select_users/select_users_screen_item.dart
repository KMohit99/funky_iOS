...
class _SelectUsersScreenItemState extends State<SelectUsersScreenItem>
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
        color: _isSelected ? Color(0xFF330417) : Colors.transparent,
        height: 60,
        child: Row(
          children: <Widget>[
            Padding(
            ...
            Expanded(
              ...
              children: <Widget>[
                Text(_formatString(widget._qbUserWrapper.name),
                    style: TextStyle(
                        fontSize: 17, fontFamily: 'PM', color: Colors.white),
            ...
            child: Checkbox(
                ...
                onChanged: (bool? changed) {
                  setState(() {
                    ...
                    _bloc?.events?.add(ChangedSelectedUsersEvent(
                        widget._qbUserWrapper, !_isSelected));
                  });
                }))
      ],
    );
